...
module.exports = {
    ...
    updateEmployeeDataByHR: function(req,res){
        ...
        try {
        mysql.query("UPDATE `employeemaster` SET `FirstName`=?,`LastName`=?,`Designation`=?,`Password`=?,`HighestQualification`=?,`ContactNo`=?,`Gender`=?,`PriorExprience`=?, `integraExperience`=?,`DateOfBirth`=?,`DateOfJoining`=?,`DateOfLeaving`=?,`ModifiedDate`=?,`RoleId`=?,`PrimarySkill`=?,`ReportingManager`=?,`IsReportingHead`=?,`ModifiedBy`=?,`Availability`=? where `EmployeeId`=?", [req.body.FirstName,req.body.LastName,req.body.Designation,encryptedString,req.body.HighestQualification,req.body.ContactNo,req.body.Gender,req.body.PriorExprience,req.body.integraExperience,req.body.DateOfBirth,req.body.DateOfJoining,req.body.DateOfLeaving,date, req.body.RoleId,req.body.PrimarySkill,req.body.ReportingManager,req.body.IsReportingHead,req.body.ModifiedBy,req.body.Availability, req.body.EmployeeId] , function(err,result) {
