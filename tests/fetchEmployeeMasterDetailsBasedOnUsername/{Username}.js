 ...
 */
Test('/fetchEmployeeMasterDetailsBasedOnUsername/{Username}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test fetchEmployeeMasterDetailsBasedOnUsername_getByUsername get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/fetchEmployeeMasterDetailsBasedOnUsername/{Username}']['get']['responses']['200']['schema']);
