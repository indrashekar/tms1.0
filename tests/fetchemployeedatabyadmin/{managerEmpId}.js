 ...
 */
Test('/fetchemployeedatabyadmin/{managerEmpId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test fetchemployeedatabyadmin_getByEmployeeId get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/fetchemployeedatabyadmin/{managerEmpId}']['get']['responses']['200']['schema']);
