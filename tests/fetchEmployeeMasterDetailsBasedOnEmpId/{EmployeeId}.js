 ...
 */
Test('/fetchEmployeeMasterDetailsBasedOnEmpId/{EmployeeId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test fetchEmployeeMasterDetailsBasedOnEmpId_getByEmployeeId get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/fetchEmployeeMasterDetailsBasedOnEmpId/{EmployeeId}']['get']['responses']['200']['schema']);
