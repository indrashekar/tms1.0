 ...
 */
Test('/fetchEmployeeMasterdetailsByManager/{managerEmpId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test fetchEmployeeMasterdetailsByManager_getByEmployeeId get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/fetchEmployeeMasterdetailsByManager/{managerEmpId}']['get']['responses']['200']['schema']);
