 ...
 */
Test('/viewSelfEmployeeResourceSkills/{UserId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test viewSelfEmployeeResourceSkills_getByUserId get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/viewSelfEmployeeResourceSkills/{UserId}']['get']['responses']['200']['schema']);
