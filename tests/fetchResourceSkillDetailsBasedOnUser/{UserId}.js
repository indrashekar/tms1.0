 ...
 */
Test('/fetchResourceSkillDetailsBasedOnUser/{UserId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test fetchResourceSkillDetailsBasedOnUser_getByUserId get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/fetchResourceSkillDetailsBasedOnUser/{UserId}']['get']['responses']['200']['schema']);
