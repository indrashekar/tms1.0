 ...
 */
Test('/updateskillcategoryforadmin', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test updateskillcategoryforadmin_put put operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/updateskillcategoryforadmin']['put']['responses']['200']['schema']);
