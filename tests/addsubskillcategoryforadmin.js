 ...
 */
Test('/addsubskillcategoryforadmin', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test addSkillMaster_post post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/addsubskillcategoryforadmin']['post']['responses']['200']['schema']);
