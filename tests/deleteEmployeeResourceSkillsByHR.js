 ...
 */
Test('/deleteEmployeeResourceSkillsByHR', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test deleteEmployeeResourceSkillsByHR_put put operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/deleteEmployeeResourceSkillsByHR']['put']['responses']['200']['schema']);
