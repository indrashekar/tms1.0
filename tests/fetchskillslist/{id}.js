 ...
 */
Test('/fetchAllReportingHeadsupdate/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test fetchAllReportingHeadsupdateById get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/fetchAllReportingHeadsupdate/{id}']['get']['responses']['200']['schema']);
