 ...
 */
Test('/deleteEmployeeMasterdetailByHR', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test deleteEmployeeMasterdetailByHR_put put operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/deleteEmployeeMasterdetailByHR']['put']['responses']['200']['schema']);
